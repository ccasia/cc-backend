...
const userData = {
  ...
  avatar_url:
    'https://p16-sign-sg.tiktokcdn.com/tos-alisg-avt-0068/fc2fabb4861df36417191839dfcaa746~tplv-tiktokx-cropcenter:168:168.jpeg?dr=14577&refresh_token=a739bd9a&x-expires=1749718800&x-signature=m5pYoW5GmX8RzlOOGUYI4g1NIIQ%3D&t=4d5b0474&ps=13740610&shp=a5d48078&shcp=8aecc5ac&idc=maliva',
...
async function connectTikTokUser(userId: string) {
  try {
    ...
    const engagement_rate = follower_count ? ((likes_count + averageComments) / follower_count) * 100 : 0;
...
async function main() {
  // Your test user IDs
  const userIds = ['cmbyk1e4t0000mrq8k0ykd3lw'];
