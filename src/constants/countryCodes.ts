...
export const PHONE_CODES: PhoneCode[] = [
  ...
  { iso: 'AG', country: 'Antigua and Barbuda', code: '1-268' },
  ...
  { iso: 'VG', country: 'British Virgin Islands', code: '1-284' },
  ...
  { iso: 'CC', country: 'Cocos (Keeling) Islands', code: '61' },
  { iso: 'CO', country: 'Colombia', code: '57' },
  { iso: 'KM', country: 'Comoros', code: '269' },
  { iso: 'CD', country: 'Congo, Democratic Republic of the', code: '243' },
  { iso: 'CG', country: 'Congo, Republic of the', code: '242' },
  ...
  { iso: 'DO', country: 'Dominican Republic', code: '1-809' },
  ...
  { iso: 'TF', country: 'French Southern Territories', code: '262' },
  ...
  { iso: 'HM', country: 'Heard Island and McDonald Islands', code: '672' },
  { iso: 'VA', country: 'Holy See (Vatican City State)', code: '379' },
  ...
  { iso: 'KN', country: 'Saint Kitts and Nevis', code: '1-869' },
  { iso: 'LC', country: 'Saint Lucia', code: '1-758' },
  { iso: 'MF', country: 'Saint Martin (French part)', code: '590' },
  { iso: 'PM', country: 'Saint Pierre and Miquelon', code: '508' },
  { iso: 'VC', country: 'Saint Vincent and the Grenadines', code: '1-784' },
  ...
  { iso: 'SX', country: 'Sint Maarten (Dutch part)', code: '1-721' },
  ...
  { iso: 'GS', country: 'South Georgia and the South Sandwich Islands', code: '500' },
  ...
  { iso: 'TZ', country: 'United Republic of Tanzania', code: '255' },
  { iso: 'US', country: 'United States', code: '1' },
  { iso: 'UY', country: 'Uruguay', code: '598' },
  { iso: 'VI', country: 'US Virgin Islands', code: '1-340' },
