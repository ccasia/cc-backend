...
export const clientInvitation = (email: string, clientName: string, campaignId: string) => {
  transport
    .sendMail({
      from: user,
      to: email,
      subject: `🎉 You’ve Been Invited to the Client's Platform`,
      html: `
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>🎉 You’ve Been Invited to the Client's Platform</title>
    </head>
    ...
    <div class="header" style="display: flex; align-items: center; margin-bottom: 30px;">
      ...
      <h2 style="color: #686464; font-size: 24px; font-weight: bold; margin-top: 40px; margin-bottom: 40px;">🥳 You’ve Been Invited to the Client's Platform</h2>
      <p style="color: #686464; text-align: left; font-size: 14px; line-height: 1.6; font-family: 'Roboto', sans-serif;">Hi ${clientName}! You have been invited to the client's platform. Please click the button below to view the details.</p>
      <a href="${process.env.BASE_EMAIL_URL}/dashboard/campaign/VUquQR/HJUboKDBwJi71KQ==/manage/detail/${campaignId}" class="button" style="display: inline-block; padding: 15px 30px; background-color: #1340FF; text-decoration: none; border-radius: 6px; font-size: 16px; color: #ffffff; text-align: center; margin: 30px auto; display: block; font-weight: bold; transition: background-color 0.3s;">Access Platform</a>
      <div class="separator" style="border-top: 1px solid #ddd; margin: 35px 0;"></div>
      <p id="slogan" style="color: #686464; font-size: 12px; padding-top: 0px; display: block; text-align: center; font-weight: bold; margin-bottom: 20px;">Where Brands and Creatives Co-create</p>
